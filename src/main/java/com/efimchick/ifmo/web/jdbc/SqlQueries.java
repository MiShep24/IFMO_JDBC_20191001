...
public class SqlQueries {
    ...
    //language=HSQLDB
    String select06 = "select EMPLOYEE.id, EMPLOYEE.firstname, EMPLOYEE.department, EMPLOYEE.lastname, EMPLOYEE.salary, EMPLOYEE.middlename, department.id, department.name as \"depname\"" +
    ...
    //language=HSQLDB
    String select10 = "select employee1.lastname AS \"employee\", employee2.lastname AS \"manager\" "+
